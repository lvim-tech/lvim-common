-- lvim-common.gx: universal "open under cursor" — resolves URLs, local paths (with optional
...
--
---@module "lvim-common.gx"

local config_mod = require("lvim-common.config")
...
--- Usually called with no args: `require("lvim-common").setup({ gx = {...} })` has already merged
